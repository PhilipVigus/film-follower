...
class UserTest extends TestCase
{
    ...
    public function a_user_can_prioritie_by_many_films()
    {
        ...
        $filmA->priorities()->save(new Priority(['user_id' => $user->id, 'priority' => Priority::MEDIUM]));
        $filmB->priorities()->save(new Priority(['user_id' => $user->id, 'priority' => Priority::MEDIUM]));
